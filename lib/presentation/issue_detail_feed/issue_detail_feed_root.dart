...
import 'package:could_be/presentation/issue_detail_feed/components/sector_divider.dart';
...
class _IssueDetailFeedRootState extends State<IssueDetailFeedRoot> {
  ...
  void _onScroll() {
    if (controller.hasClients) {
      ...
      if(currentScroll > maxScroll *0.3 && !viewModel.state.hasShowedBiasButton){
        viewModel.showBiasButton(context);
      }
                              ...
                              children: [
                                ...
                                ListenableBuilder(
                                  ...
                                  builder: (context, listenable) {
                                    return SectorBox(
                                      content: IssueDetailBiasComparison(
                                        fontSize: state.fontSize,
                                        ...
                                        isSpread:
                                            state.isBiasComparisonSpread,
                                        spreadCallback:
                                            viewModel.spreadBiasComparison,
                                      ),
                                    );
                                  },
                                ),
                                ...
                                MajorUserOpinionView(
                                  fontSize: state.fontSize,
                                  isSpread: state.isMajorCommentsSpread,
                                  spreadCallback: viewModel.spreadMajorComments,
                                ...
                                SourceListPage(
                                  articlesGBBAS:
                                      issue.articles.toGroupByBiasAndSource(),
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      child: ElevatedButton(
                                        onPressed: issue.nextIssueIds.isNotEmpty ? () {
                                          viewModel.fetchIssueDetailById(
                                            issue.nextIssueIds.first,);
                                        } : () {context.pop();},
                                        style: ElevatedButton.styleFrom(
