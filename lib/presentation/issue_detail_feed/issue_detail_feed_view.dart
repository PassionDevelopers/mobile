...
//     required this.manageUserEvaluation,
//   });
//
//   final IssueDetail issue;
//   final VoidCallback manageIssueSubscription;
//   final void Function(Bias bias) manageUserEvaluation;
//
//   @override
...
//
//                   ListenableBuilder(
//                     listenable: ValueNotifier(issue),
//                     builder: (context, listenable) {
//                       return Padding(
//                         padding: EdgeInsets.symmetric(horizontal: MyPaddings.large),
//                         child: IssueDetailBiasComparison(
//                           onBiasSelected: widget.manageUserEvaluation,
