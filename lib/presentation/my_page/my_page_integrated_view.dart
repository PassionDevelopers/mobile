...
import 'user_bias_status/my_bias_status_view.dart';

class MyPageIntegratedView extends StatefulWidget {
  const MyPageIntegratedView({
    super.key,
  ...
  @override
  State<MyPageIntegratedView> createState() => _MyPageIntegratedViewState();
}

class _MyPageIntegratedViewState extends State<MyPageIntegratedView>
    ...
    return RegScaffold(
      ...
      body: CustomScrollView(
        slivers: [
          ...
          SliverToBoxAdapter(
            child: _buildMinimalProfileHeader(viewModel),
          ),
          ...
          // Bottom Padding
          SliverToBoxAdapter(
            child: SizedBox(height: MyPaddings.extraLarge * 2),
          ),
        ],
      ),
    );
      ...
      child: Stack(
        ...
        builder: (context, _) {
          ...
          if (state.isBiasLoading || state.userBias == null) {
            return _buildMinimalLoadingState();
          }
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(
                          color: getBiasColor(state.userBias!.bias).withOpacity(0.2),
                          width: 1.5,
                        ),
                      ),
                      child: Icon(
                            ...
                            TextButton(
                              onPressed: () {
                                setState(() {
                                  isEditMode = false;
                                  final state = viewModel.state;
                                  if (state.userBias != null) {
                                    nicknameController.text = state.userBias!.nickname;
                                  }
                                });
                              },
                              style: TextButton.styleFrom(
  ...
  Widget _buildMinimalLoadingState() {
    return Container(
      padding: EdgeInsets.symmetric(vertical: MyPaddings.large),
      child: Row(
        children: [
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // Summary
          Container(
            margin: EdgeInsets.symmetric(horizontal: MyPaddings.extraLarge, vertical: MyPaddings.large),
            padding: EdgeInsets.all(MyPaddings.extraLarge),
            decoration: BoxDecoration(
              color: AppColors.gray5,
              borderRadius: BorderRadius.circular(16),
