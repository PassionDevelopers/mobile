            ...
            child: Column(
              children: [
                ...
                BigButton(
                  ...
                  onPressed: () async {
                    final Uri url = Uri.parse(
                      'https://www.instagram.com/tigerstone1263',
                    );
                ...
                BigButton(
                  ...
                  onPressed: () async {
                    final Uri url = Uri.parse(
                      'https://tigerstone1263.github.io/PrivacyPolicy/termsOfService.html',
                    );
                    if (!await launchUrl(url)) {
                ...
                BigButton(
                  ...
                  onPressed: () async {
                    final Uri url = Uri.parse(
                      'https://tigerstone1263.github.io/PrivacyPolicy/AbsoluteEarPolicy.html',
                    );
                    if (!await launchUrl(url)) {
                      throw Exception('페이지를 로드할 수 없습니다.');
                    }
