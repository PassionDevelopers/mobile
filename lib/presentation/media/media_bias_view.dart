...
//         return MediaProfile(bias: bias, fileName: fileNames[index], name: names[index], isShowingArticles: false,);
//       },
//     );
//   }
//
...
//                 MediaProfile(bias: bias, name: medias[index], fileName: mediasName[index], isShowingArticles: false,)
//               ],
//             ),
//           ),
//         ],
